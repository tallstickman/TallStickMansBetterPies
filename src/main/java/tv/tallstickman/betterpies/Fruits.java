...
public class Fruits {
	...
	public static final FoodComponent BLACKBERRIES_FOOD_COMPONENT = (new FoodComponent.Builder()).nutrition(2).saturationModifier(0.1F).build();
	...
	public static final FoodComponent BLUEBERRIES_FOOD_COMPONENT = (new FoodComponent.Builder()).nutrition(2).saturationModifier(0.1F).build();
	...
	public static final FoodComponent CHERRIES_FOOD_COMPONENT = (new FoodComponent.Builder()).nutrition(4).saturationModifier(0.3F).build();
	...
	public static void initialize()
	{
		...
		LootTableEvents.MODIFY.register((id, tableBuilder, source, wrapper) -> {
			if (source.isBuiltin() && CHERRY_LEAVES_LOOT_TABLE_ID.isPresent() && CHERRY_LEAVES_LOOT_TABLE_ID.get().equals(id)) {
